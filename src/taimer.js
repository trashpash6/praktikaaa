...
const Timer = () => {
  ...
  return (
    <div>
      <div>
        <input id="minutes" type="number" min="0" max="59" value={minutes} onChange={handleMinutesChange} disabled={running} />
        <span>:</span>
      ...
      <div className={btn.block}>
        ...
        <button className={btn.style} onClick={resetTimer}>Reset</button></div>
    </div>
  );
};
